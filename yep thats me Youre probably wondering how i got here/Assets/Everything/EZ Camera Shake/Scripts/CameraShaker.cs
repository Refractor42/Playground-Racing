...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        {
            DefaultPosInfluence = new Vector3(0.065f, 0.065f, 0.065f);
            DefaultRotInfluence = new Vector3(0.065f, 0.065f, 0.065f);
            Invoke("EndNOS", 5f);
        }

        void EndNOS()
        {
            DefaultPosInfluence = new Vector3(0.02f, 0.02f, 0.02f);
            DefaultRotInfluence = new Vector3(0.02f, 0.02f, 0.02f);
        }
    }
}